...
learning_rate = 4e-4
micro_batch_size = 8
max_step = (715256 * 2*50) // (30*100) # 50B  # 100B tokens -> (715256*2)//30
warmup_steps = 2000
...
def setup(
    ...
    fabric = L.Fabric(devices=devices, num_nodes=num_nodes, strategy=strategy, precision=precision, loggers=[logger, wandb_logger])
